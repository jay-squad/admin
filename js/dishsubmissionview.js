...
$(document).ready(function() {
      ...
      var uploader = new qq.s3.FineUploader({
          ...
          request: {
              endpoint: 'https://foodie-prod-dish-images.s3.amazonaws.com',
          },
          credentials: {
              accessKey: getCookie("aws_access_key"),
              secretKey: getCookie("aws_secret_key"),
              expiration: d
          },
          signature: {
              version: 4
          ...
          callbacks: {
              onComplete: function(id, name, responseJSON, xhr) {
                  uploaded[id] = 'https://s3.us-east-2.amazonaws.com/foodie-prod-dish-images/' + uploaded[id]
              },
